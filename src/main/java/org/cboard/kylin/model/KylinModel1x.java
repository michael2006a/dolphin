...
/**
 * Created by zyong on 2017/4/11. columns: Array[column] tableAlias: Map<db.table, _tnn>
 * columnTable: Map<column, db.table> columnType: Map<column, dataType>
 */
public class KylinModel1x extends KylinBaseModel {

  public KylinModel1x(JSONObject model, Map<String, String> dataSource, Map<String, String> query,
