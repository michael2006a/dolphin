...
public class KylinDataProvider extends DataProvider implements Aggregatable, Initializing {
  ...
  private Connection getConnection() throws Exception {
    ...
    return DriverManager.getConnection(String
            .format("jdbc:kylin:%S//%s/%s", timeZone, dataSource.get(SERVERIP), query.get(PROJECT)),
        props);
  }
  ...
  public String[] queryDimVals(String columnName, AggConfig config) throws Exception {
    ...
    exec = String.format(fsql, columnAliasName, kylinModel.formatTableName(tableName),
        kylinModel.formatTableName(kylinModel.getAliasfromColumn(columnName)), whereStr,
