...
public class SaikuDataProvider extends DataProvider {
  ...
  public String[][] getData() throws Exception {
    ...
    ResponseEntity<String> a = restTemplate.postForEntity(
        serverIp + "/saiku/rest/saiku/session?username={username}&password={password}", null,
    ...
    restTemplate.exchange(
        serverIp + "/saiku/rest/saiku/api/query/{id}?file={file}&formatter={formatter}&type={type}",
        HttpMethod.POST, new HttpEntity<>(headers), String.class, uuid, file, "flattened", "QM");
    a = restTemplate
        .exchange(serverIp + "/saiku/rest/saiku/api/query/{id}/result/flattened", HttpMethod.GET,
            new HttpEntity<>(headers), String.class, uuid);
    JSONObject jsonObject = JSONObject
        .parseObject(new String(a.getBody().getBytes("ISO8859-1"), "UTF-8"));
    ...
    String[][] result = new String[jsonObject.getInteger("height") - (i - 1)][jsonObject
        .getInteger("width")];
