...
public class FileDataProvider extends DataProvider {
  ...
  public String[][] getData() throws Exception {
    ...
    String encoding = StringUtils.isBlank(query.get(QUERY_PARAM_ENCODING)) ? "UTF-8"
        : query.get(QUERY_PARAM_ENCODING);
    String dataType = StringUtils.isBlank(query.get(QUERY_PARAM_DATA_TYPE)) ? "DSV"
        : query.get(QUERY_PARAM_DATA_TYPE);
  ...
  public String[][] dealCSV(BufferedReader reader, String filedNames, String seprator,
    ...
    try {
      ...
      while ((tempString = reader.readLine()) != null) {
        ...
        csv = newReader(new CharArrayReader(tempString.toCharArray()), sepratorChar, quoteChar,
            escapeChar);
  ...
  public String[][] dealDSV(BufferedReader reader, String filedNames, String seprator,
      String quoteStr) {
    String tempString = null;
    List<String[]> result = new LinkedList<>();
    int line = 0;
